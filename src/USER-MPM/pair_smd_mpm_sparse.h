...
PairStyle(smd/mpm_sparse,PairSmdMpmSparse)

#else

#ifndef LMP_SMD_MPM_SPARSE_H
#define LMP_SMD_MPM_SPARSE_H
...
class PairSmdMpmSparse: public Pair {
public:
	PairSmdMpmSparse(class LAMMPS *);
	virtual ~PairSmdMpmSparse();
...
protected:
	...
	openvdb::Vec3dGrid::Ptr grid_vel;
	openvdb::Vec3dGrid::Ptr grid_force;
	openvdb::Vec3dGrid::Ptr grid_velest;
	openvdb::DoubleGrid::Ptr grid_heat;
	openvdb::DoubleGrid::Ptr grid_dheat_dt;
	openvdb::BoolGrid::Ptr grid_BC_status;
