...
CommandStyle(smd_run_duration,SmdRunDuration)

#else

#ifndef LMP_SMD_RUN_DURATION_H
#define LMP_SMD_RUN_DURATION_H

#include "pointers.h"

namespace LAMMPS_NS {

class SmdRunDuration : protected Pointers {
 public:
  SmdRunDuration(class LAMMPS *);
