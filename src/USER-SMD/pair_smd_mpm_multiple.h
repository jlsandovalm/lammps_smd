...
PairStyle(smd/mpm/multiple,PairSmdMpmMultiple)

#else

#ifndef LMP_SMD_MPM_MULTIPLE_H
#define LMP_SMD_MPM_MULTIPLE_H
...
class PairSmdMpmMultiple: public Pair {
public:
	PairSmdMpmMultiple(class LAMMPS *);
	virtual ~PairSmdMpmMultiple();
...
protected:
	...
	int *type2part; // maps particle type to MPM part number
