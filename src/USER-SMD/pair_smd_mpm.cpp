...
void PairSmdMpm::PointsToGrid() {
	...
	Vector3d vel_APIC, vel_particle, dx;
...
//	} else {
//		error->all(FLERR,
//				"Illegal settings keyword for first keyword of pair style mpm. Must be either *DENSITY_SUMMATION or *DENSITY_CONTINUITY");
//	}
